describe("Scope", function() {
    ...
    describe("digest", function() {
        ...
        it("calls the listener function of a watch on first $diget", function() {
        ...
        it("calls the listener function when the watched valude changes", function() {
            scope.someValue = 'a';
            scope.counter = 0;
        ...
        it("does not include $$postDigest in the digest", function() {
            ...
            scope.$digest();
            expect(scope.watchedValue).toBe('originial value');
    ...
    describe("inheritence", function() {
        ...
        it("doesn not cause a parent to inherit its properties", function() {
            var parent = new Scope();
        ...
        it("can manipulate a prent scope's property", function() {
            var parent = new Scope();
            var child = parent.$new();
            parent.aValue = [1, 2, 3];
        ...
        it("does not shadows members of parent scope's attributes", function() {
            var parent = new Scope();
            var child = parent.$new();
